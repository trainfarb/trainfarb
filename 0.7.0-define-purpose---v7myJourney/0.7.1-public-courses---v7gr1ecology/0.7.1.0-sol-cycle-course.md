...
* Download and Print [ADD LINK] your Thought form and notes page.
  * If you choose this option, trace the dotted lines to benefit from drawing sacred geometry [(Video about the benefits)](https://youtu.be/UVWAh9cYIOs).
* or...Download and use as a reference to draw your own Thought Form on a blank sheet of paper.
...
### Step 7 Brainstorm:
On your notes page, list out some of your favorite movies, tv shows, cartoons, books, comics, super heros, etc.

### Step 7 Action:
In your **REFINE Story** sphere, complete the phrase "Once upon a time, [A PHRASE ABOUT WHERE YOU'RE STARTING WITH YOUR HOBBY]."
...
3. Share a photo of your completed thought form to the #define-purpose channel in [ourStory's Discord Server](https://discord.gg/X8knzgty)
4. (Optional) Share a photo of your thought form to your Instagram Profile (or Story) using the following:
  - @cohortBased #b7learn
...
Next, you will complete the wOl Cycle Course [369mPI] [LINK] to create the project plan for turning your hobby into a vocation.
